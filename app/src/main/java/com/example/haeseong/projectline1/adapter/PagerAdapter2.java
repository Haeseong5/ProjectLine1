...
public class PagerAdapter2 extends PagerAdapter {
    ...
    public PagerAdapter2(FragmentManager fragmentManager, ArrayList<UserData> userDataArrayList, Context context)
    {
        super(fragmentManager,userDataArrayList,context);
