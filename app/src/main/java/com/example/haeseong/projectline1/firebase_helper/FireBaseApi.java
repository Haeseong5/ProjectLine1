package com.example.haeseong.projectline1.firebase_helper;
...
//                    Log.d("server key: ",R..fcm_server_key);
    ...
    public static void getUriStorage(OnSuccessListener<Uri> onSuccessListener, OnFailureListener onFailureListener){
        final StorageReference profileRef = storageReference.child("profile_images/"+firebaseUser.getUid()).child(firebaseUser.getDisplayName()+".jpg");
